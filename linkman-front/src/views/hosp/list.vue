<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="searchObj.hosname" clearable placeholder="医院名称"/>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    provinceChanged() {
      ...
      if (this.searchObj.provinceCode) {
        hosp.findChildId(this.searchObj.provinceCode)
          .then(response => {
    ...
    updateStatus(id, status) {
      hosp.updateHospStatus(id, status).then(response => {
        this.fetchData(1)
      })
    }
  }
