<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" stripe style="width:100%">
      ...
      <el-table-column prop="info" label="报修物品" />
      <el-table-column prop="beizhu" label="损坏描述" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" v-model="form" label-width="80px">
        <el-row>
          <el-col :span="20">
            <el-form-item label="用户昵称" prop="name">
              <el-input v-model="form.name" placeholder="请输入用户昵称" maxlength="50" />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="报修物品" prop="info">
              <el-input v-model="form.info" placeholder="请输入报修物品" maxlength="50" />
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="损坏描述" prop="beizhu">
              <el-input v-model="form.beizhu" placeholder="请输入损坏描述" maxlength="50" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 提交按钮 */
    submitForm() {
      orderInfoApi.addUser(this.form).then(response => {
        this.open = false;
        if (this.form.id) {
          this.$message({
            type: 'success',
